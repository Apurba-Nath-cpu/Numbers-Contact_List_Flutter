...
class _HomeState extends State<Home> {
  ...
  // Get data about posts from a user
                                            ...
                                            GestureDetector(
                                              onTap: () {
                                                ...
                                                showDialog(
                                                  ...
                                                  builder: (ctx) => AlertDialog(
                                                    title: Text(
                                                        'Do you want to delete ${snapshot.data!.docs[index].data()['name']}\'s contact?'),
                                                    actions: <Widget>[
                                                      TextButton(
                                                        onPressed: () {
                                                          deleteContact(snapshot
                                                                  .data!
                                                                  .docs[index]
                                                                  .data()[
                                                              'postId']);
...
class CustomSearchDelegate extends SearchDelegate {
  ...
  Future<List<String>> getSearchTerms() async {
    ...
    return postSnap.docs
        .map((doc) =>
            (doc['name'] + ': ' + doc['number'] + '(' + doc['relation'] + ')')
                .toString())
        .toList();
  }
